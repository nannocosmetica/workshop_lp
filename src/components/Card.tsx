...
const Card = ({ icon, name, text }: IProps) => {
  return (
    <div className="flex flex-col min-h-96 overflow-hidden rounded-lg bg-neutral-800 text-white w-full md:max-w-3/12">
      <div className="flex flex-1 flex-col px-8">
        ...
        <div className="flex flex-1 flex-col">
          <span className="text-sm font-light uppercase tracking-[8px]">
            {name}
          </span>
